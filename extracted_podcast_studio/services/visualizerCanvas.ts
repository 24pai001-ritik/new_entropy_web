...
export const drawImpactfulImage = (
    ctx: VisualizerContext,
    img: CanvasImageSource | OffscreenCanvas | ImageBitmap,
    time: number,
    start: number,
    end: number,
    w: number,
    ...
    // Draw image to cover or fit
    // For now, let's do a centered "contained" or slightly "covered" look
