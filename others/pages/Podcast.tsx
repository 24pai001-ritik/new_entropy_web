...
import { AppState, PodcastSettings, OutlineData, Caption } from '../extracted_podcast_studio/types';
import { InputForm } from '../extracted_podcast_studio/components/InputForm';
import { ScriptDisplay } from '../extracted_podcast_studio/components/ScriptDisplay';
import { AudioPlayer } from '../extracted_podcast_studio/components/AudioPlayer';
import { OutlineDisplay } from '../extracted_podcast_studio/components/OutlineDisplay';
import { ScriptEditor } from '../extracted_podcast_studio/components/ScriptEditor';
import { generateScript, generateAudio, generateOutline, detectImpactfulWords, generateImpactImage } from '../extracted_podcast_studio/services/gemini';
import { decodeBase64, decodeAudioData, mixPodcastAudio, concatenateAudioBuffers, trimAudioBuffer } from '../extracted_podcast_studio/services/audioUtils';
import { Mic2, Sparkles, Clapperboard, FileText, CheckCircle2, Circle, Radio, Activity, Cast } from 'lucide-react';
import { DEFAULT_HOSTS } from '../extracted_podcast_studio/constants';
...
export default function Podcast() {
    ...
    return (
        <div className="min-h-screen text-slate-100 selection:bg-blue-500/30 relative overflow-hidden font-sans pt-20">
            ...
            {/* Header */}
            <header className="border-b border-white/5 bg-[#0f172a]/80 backdrop-blur-md sticky top-20 z-40 transition-all duration-300">
                            ...
                            <div className="xl:col-span-2 space-y-6">
                                ...
                                <div className="relative group">
                                    ...
                                    <AudioPlayer
                                        ...
                                        captions={captions}
                                        logo={settings.logo}
                                        firstImage={settings.firstImage}
                                        lastImage={settings.lastImage}
